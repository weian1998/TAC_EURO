...
set _DeploySetParametersFile=%RootPath%EuroProcessEmailArchiveWebService.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%EuroProcessEmailArchiveWebService.zip" (
echo "%RootPath%EuroProcessEmailArchiveWebService.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%EuroProcessEmailArchiveWebService.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%EuroProcessEmailArchiveWebService.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%EuroProcessEmailArchiveWebService.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%EuroProcessEmailArchiveWebService.SetParameters.xml" %_MsDeployAdditionalFlags%
...
:usage
echo =========================================================
if not exist "%RootPath%EuroProcessEmailArchiveWebService.deploy-readme.txt" (
...
start notepad "%RootPath%EuroProcessEmailArchiveWebService.deploy-readme.txt"
)
echo =========================================================
goto :eof
...
:CheckParameterFile
echo =========================================================
if  exist "%RootPath%EuroProcessEmailArchiveWebService.SetParameters.xml" (
echo SetParameters from:
echo "%RootPath%EuroProcessEmailArchiveWebService.SetParameters.xml"
echo You can change IIS Application Name, Physical path, connectionString
echo or other deploy parameters in the above file.
) else (
echo SetParamterFiles does not exist in package location.
