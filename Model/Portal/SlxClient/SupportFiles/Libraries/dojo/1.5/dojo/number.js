...
return _7.replace(_f,dojo.number._formatAbsolute(_6,_10[0],{decimal:_a,group:_9,places:_8.places,round:_8.round,maxPlaces:_8.maxPlaces}));
};
...
if (_1b < _1d.length) {
    _1b = (_18.maxPlaces) ? _18.maxPlaces : _1b;
