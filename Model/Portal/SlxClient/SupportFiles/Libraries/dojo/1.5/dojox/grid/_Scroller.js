...
this.height+=_33;
this.resize();
},updatePageHeight:function(_34,_35,_SLX99){
...
return 0;
},rowHeightChanged:function(_36,_SLX99){
this.updatePageHeight(Math.floor(_36/this.rowsPerPage),false,_SLX99);
...
this.buildPage(_3d,(!this.grid._autoHeight/*fix #10543*/ && this.keepPages&&(this.stack.length >= this.keepPages)),_3e);
