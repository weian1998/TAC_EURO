<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DeleteRecurrence.ascx.cs" Inherits="SmartParts_Activity_DeleteRecurrence" %>
...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
    ...
    <tr>
        <td colspan="2">
            <asp:RadioButtonList ID="rblRecurrenceType" runat="Server">
