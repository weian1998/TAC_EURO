<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CompleteRecurrence.ascx.cs" Inherits="SmartParts_Activity_CompleteRecurrence" %>
...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
    <tr>
     ...
     <tr>
        ...
        <td><asp:Label ID="Contact" runat="server" ></asp:Label></asp:Label></td>
    </tr>
     <tr>
    ...
    <tr >
        <td><asp:Button ID="btnContinue" runat="Server" OnClick="btnContinue_Click" Text="<%$ resources: btnContinue.Text %>" /></td>
    </tr>
</table>
