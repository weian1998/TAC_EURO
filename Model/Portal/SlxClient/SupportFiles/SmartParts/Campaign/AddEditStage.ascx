...
<SalesLogix:ScriptResourceProvider ID="AddEditStage_Strings" runat="server">
    <Keys>
        <SalesLogix:ResourceKeyName Key="CodeChangeMSG" />
        <SalesLogix:ResourceKeyName Key="cmdSave.Caption" />
        <SalesLogix:ResourceKeyName Key="cmdCancel.Caption" />
    </Keys>
...
<table id="Table2" border="0" cellpadding="1" cellspacing="2" class="formtable">
    ...
    <tr>
        <td>  
            ...
            <div class="textcontrol lookup">
                <SalesLogix:LookupControl runat="server" ID="luLeadSource" ButtonToolTip="<%$ resources: LeadSource.ButtonToolTip %>" LookupEntityName="LeadSource" LookupEntityTypeName="Sage.Entity.Interfaces.ILeadSource, Sage.Entity.Interfaces, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null" >
                    <LookupProperties>
                        <SalesLogix:LookupProperty PropertyHeader="Type" meta:resourcekey="LeadSourceType" PropertyName="Type" PropertyFormat="None"
                            PropertyType="System.String" UseAsResult="True" ExcludeFromFilters="False">
                        </SalesLogix:LookupProperty>
                        <SalesLogix:LookupProperty PropertyHeader="Description" meta:resourcekey="LeadSourceDescription" PropertyName="Description"
                            PropertyFormat="None" PropertyType="System.String" UseAsResult="True" ExcludeFromFilters="False">
                        </SalesLogix:LookupProperty>
                        <SalesLogix:LookupProperty PropertyHeader="Abbrev" meta:resourcekey="LeadSourceAbbrev" PropertyName="AbbrevDescription"
                            PropertyFormat="None" PropertyType="System.String" UseAsResult="True" ExcludeFromFilters="False">
                        </SalesLogix:LookupProperty>
                    </LookupProperties>
                    <LookupPreFilters>
    ...
    <tr>
        <td>
            ...
            <div class="textcontrol">
                <asp:TextBox runat="server" ID="txtCode" MaxLength="32" dojoType="Sage.UI.Controls.TextBox"></asp:TextBox>
            </div>   
        </td>
        <td></td>
    </tr>
    <tr>
        <td colspan="2">
            ...
            <div class="twocoltextcontrol TEXTAREA" style="width:80%">
                <asp:TextBox runat="server" ID="txtComment" TextMode="MultiLine" Rows="4"></asp:TextBox>
            </div>
        </td>
    </tr>
</table>
    ...
    <tr>
        <td>
            <div style="overflow:auto; height:100px">
                <SalesLogix:SlxGridView runat="server" ID="grdTasks" GridLines="None" AutoGenerateColumns="False" CellPadding="4" CssClass="datagrid"
                    ...
                    meta:resourcekey="grdTasks_NoRecordFound" OnRowCommand="grdTasks_RowCommand" OnRowDeleting="grdTasks_RowDeleting" DataKeyNames="Id" 
                    EnableViewState="false" ResizableColumns="true" >
                    <Columns>
...
<table id="tblBudget" border="0" cellpadding="1" cellspacing="2" class="formtable">
    ...
    <tr>
        <td>  
            ...
            <div class="textcontrol">
                <asp:TextBox runat="server" ID="txtEstimatedHours" ReadOnly="true" Enabled="false" dojoType="Sage.UI.Controls.TextBox"></asp:TextBox>
            </div>   
        </td>
        <td>
            <div class="lbl">
            ...
            <div class="textcontrol">
                <asp:TextBox runat="server" ID="txtActualHours" ReadOnly="true" Enabled="false" dojoType="Sage.UI.Controls.TextBox"></asp:TextBox>
            </div>
        </td>
    </tr>
    <tr>
