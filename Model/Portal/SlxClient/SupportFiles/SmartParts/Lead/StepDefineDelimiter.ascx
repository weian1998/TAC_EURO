...
<table border="0" cellpadding="1" cellspacing="0" class="formtable">
    ...
    <tr>
        <td></td>
        <td>
            <asp:RadioButton ID="rdbTab" GroupName="rdgpDelimiter" Text="<%$ resources:rdgpDelimiter_Tab.Text %>" CssClass="radio" runat="server" AutoPostBack="true" />
            <asp:RadioButton ID="rdbSemiColon" GroupName="rdgpDelimiter" Text="<%$ resources:rdgpDelimiter_Semicolon.Text %>" CssClass="radio" runat="server" AutoPostBack="true" />
            <asp:RadioButton ID="rdbComma" GroupName="rdgpDelimiter" Text="<%$ resources:rdgpDelimiter_Comma.Text %>" Checked="true" CssClass="radio" runat="server" AutoPostBack="true" />
            <asp:RadioButton ID="rdbSpace" GroupName="rdgpDelimiter" Text="<%$ resources:rdgpDelimiter_Space.Text %>" runat="server" CssClass="radio" AutoPostBack="true" />
            <asp:RadioButton ID="rdbOther" GroupName="rdgpDelimiter" Text="<%$ resources:rdgpDelimiter_Other.Text %>" runat="server" CssClass="radio" AutoPostBack="true" />
            <asp:TextBox ID="txtOtherDelimiter" runat="server" MaxLength="1" AutoPostBack="true" Width="40px" OnTextChanged="txtOtherDelimiter_OnTextChanged"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td></td>
	...
	<tr>
		...
		<td>
			<br/>
				<span class="lblright">
	                <asp:Label ID="lblCaption" AssociatedControlID="lblCaption" runat="server"
	                    Text="<%$ resources:lblGridPreview.Caption %>">
	                </asp:Label>
	            </span>
		</td>
	</tr>
    <tr>
        ...
        <td>
            <SalesLogix:SlxGridView runat="server" ID="grdPreview" GridLines="None" AutoGenerateColumns="true" CellPadding="4" CssClass="datagrid"
                PagerStyle-CssClass="gridPager" AlternatingRowStyle-CssClass="rowdk" EnableViewState="false"
                RowStyle-CssClass="rowlt" SelectedRowStyle-CssClass="rowSelected" ShowEmptyTable="true" Height="150px" Width="800px"
                ExpandableRows="false" ResizableColumns="true" EmptyTableRowText="<%$ resources: grdPreview.EmptyTableRowText %>" >
