...
public partial class SmartParts_History_HistoryCommandController : EntityBoundSmartPart
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        {
            //means we dropped an email - the delete button should dissappear and cancel should delete the record...
            cmdCancel.Click += cmdDelete_ClickAction;
        }
    }
        ...
        if (hist != null)
        {
            switch (hist.Type)
            {
                case HistoryType.atAppointment:
                    return "~/images/icons/Meeting_24x24.gif";
                case HistoryType.atPhoneCall:
                    return "~/images/icons/Call_24x24.gif";
                case HistoryType.atToDo:
                    return "~/images/icons/To_Do_24x24.gif";
                case HistoryType.atPersonal:
                    return "~/images/icons/Personal_24x24.gif";
                case HistoryType.atEMail:
                    return "~/images/icons/Send_Write_email_24x24.gif";
            }
        }
        return "~/images/icons/Meeting_24x24.gif";
    }
