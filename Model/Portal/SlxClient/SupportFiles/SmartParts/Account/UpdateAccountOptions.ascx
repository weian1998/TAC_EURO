...
<table id="tblOptions" border="0" cellpadding="1" cellspacing="2" class="formtable">
    ...
    <tr>
        <td>
            <div id="divAcctMgr" runat ="server" style="display:none">
                <span class="lbltop">
                    <asp:Label ID="lblAcctMgr" AssociatedControlID="chkAcctMgr" runat="server" Text="<%$ resources: lblAcctMgr.Text %>"></asp:Label>
                </span>
                <span>
                    <asp:CheckBox runat="server" ID="chkAcctMgr" Checked="false" Enabled ="false" Text="<%$ resources: chkAcctMgr.Text %>" />
                </span>
                <br />
                <span>
                    <asp:CheckBox runat="server" ID="chkAcctMgrOpp" Checked="false" Enabled ="true" Text="<%$ resources: chkAcctMgrOpp.Text %>" />
                </span>
            </div>
        </td>
    </tr>
