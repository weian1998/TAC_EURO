        ...
        <div id="LoginForm">
            <table border="0" cellpadding="0" class="slxlogin">
                ...
                <tr>
                    <td style="padding-left: 300px; font-size: 80%" colspan="2">
                        <div>
                            <asp:Label ID="Copyright" runat="server" Text="Copyright 1997-2011"></asp:Label></div>
                        <div>
                            <asp:Label ID="Sage" runat="server" Text="Sage Software, Inc."></asp:Label></div>
                        <div>
                            <asp:Label ID="Rights" runat="server" Text="All Rights Reserved"></asp:Label></div>
                    </td>
                </tr>
                <tr>
                    <td style="padding-left: 300px">
                ...
                <tr>
                    <td colspan="2" style="font-size: 80%; padding-top: 15px;">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="right" style="padding-left: 10px; padding-right: 10px; padding-top: 10px">
                        <table cellspacing="5" cellpadding="2">
                            <tr>
                                <td style="border-left: solid 1px Black; border-bottom: solid 1px Black; width: 80px;
                                    text-align: left;">
