...
function (LanguageList, lang) {
    var nls = {
        root: {
            ...
            lblTotalRecordsProcessed: 'Leads Searched:',
            lblTotalDuplicates: 'Potential Duplicates:',
            lblProjectedDuplicateRate: 'Projected Duplicate Rate:',
            lblTotalErrors: 'Total Errors:',
