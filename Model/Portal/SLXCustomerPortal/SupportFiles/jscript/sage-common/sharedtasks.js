...
// begin Sage.TaskPane.Utility
Sage.TaskPane.Utility = {
 ...
 // end Sage.TaskPane.Utility

// ***** CommonTasksTasklet functionality *****
if (!Sage.TaskPane.Shared) {
    ...
    Sage.TaskPane.Shared.prototype.determineAdHocStatus = function () {
        ...
        this.currentGroupInfo = (typeof (getCurrentGroupInfo) === "function") ? getCurrentGroupInfo() : null;
        if (this.currentGroupInfo) {
            ...
            if (this.groupInfoList && this.groupInfoList.groupInfos) {
                ...
                for (var i = 0; i < groupLen; i++) {
                    ...
                    if (this.groupInfoList.groupInfos[i].groupID != this.currentGroupInfo.Id && this.groupInfoList.groupInfos[i].isAdHoc) {
                        // notice upper case H in isAdHoc above
                        this.hasAdHoc = true;
                        break;
                    }
                } // end for
...
} // end Sage.TaskPane.Shared

    // ***** End CommonTasksTasklet functionality *****

$(document).ready(function () {
    var container = $("ul[id*='item_CommonTasksTasklet_CommonTasksTasklet']");
    if (container.size() > 0 && Sage.TaskPane.Utility.getCurrentEntityType() !== "") {
